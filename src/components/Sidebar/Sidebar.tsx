...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* New Campaign Button */}
      <div className="p-6">
        <button className="w-full flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#22d3ee] via-[#a855f7] to-[#ec4899] px-4 py-3 text-sm font-semibold text-white transition-all hover:opacity-90 hover:shadow-lg hover:shadow-purple-500/25">
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <nav className="flex-1 px-4 py-4">
        <div className="space-y-1">
          {navItems.map((item) => {
            ...
            const isAdmin = item.alwaysPurple;
            return (
              <Link
                key={item.href}
                href={item.href}
